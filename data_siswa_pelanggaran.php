...
<div class="row">
     <!-- page header -->
    <div class="col-lg-12">
        <h1 class="page-header">Pelanggaran Siswa</h1>
    </div>
    <!--end page header -->
</div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="row">
                    ...
                    <form action="?page=data_siswa_pelanggaran" method="post">
        ...
        <div class="panel panel-default">   
            <div class="panel-body">
                ...
                if ($get_pages>$entries)  //jika jumlah semua data lebih banyak dari nilai awal yang diberikan
                {
                    ...
                    <a href="?page=data_siswa_pelanggaran&halaman=<?php echo ($pages-1); ?> " style="text-decoration:none"><font size="2" face="verdana" color="#009900"><?php echo $pages; ?></font></a>
                    <?php
                    $pages++;
                    }
                ...
                $result=mysqli_query($link,"select id_bimbingan, siswa.photo as posiswa, nama_siswa, nama_guru, nis, nama_kelas, ortu.photo as portu, nama_orangtua from tbl_siswa_bimbingan bimbingan, tbl_ruangan ruangan, tbl_akses_ortu aksesortu, data_orangtua ortu, data_siswa siswa,data_guru guru, setup_kelas kelas where bimbingan.id_siswa=siswa.id_siswa and bimbingan.id_siswa=ruangan.id_siswa and ruangan.id_kelas=kelas.id_kelas and bimbingan.id_siswa=aksesortu.id_siswa and aksesortu.id_orangtua=ortu.id_orangtua and bimbingan.id_guru=guru.id_guru  and bimbingan.id_guru='$id_guru' $filter_siswa order by siswa.nama_siswa asc limit $offset,$entries"); //output
                ?>
                </center>
                ...
                <tr>
                    ...
                    <a href="javascript:;"  title="Cetak Laporan Pelanggaran ke File PDF"><img src="images/detail.png" border="0" onClick="window.open('./pdf/export_pdf_pelanggaran.php?id_bimbingan=<?php echo $id_bimbingan;?>&nama_kelas=<?php echo $nama_kelas;?>&nama_siswa=<?php echo $nama_siswa;?>&nis=<?php echo $nis;?>&nama_guru=<?php echo $guru_bk;?>&photo=<?php echo $photo_siswa;?>&logo=<?php echo $photo_siswa;?>','scrollwindow','top=200,left=300,width=800,height=500');"></a>
